...
M3 adds installable CMake package metadata for MatCal.
...
target_link_libraries(app PRIVATE MatCal::Legacy MatCal::Linalg MatCal::Polynomial)
```
...
- SFL/FEM integration is still out of scope for M3.
